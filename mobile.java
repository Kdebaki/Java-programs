package week3;
//15.Design and implement a class for mobile store with given attributes make,model,category,price,discount,net_price.Use constructors to instantiate objects and display details. 
