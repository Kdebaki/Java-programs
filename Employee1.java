//13.Learn and understand use of constructors and itstypes, and implement the same for employee class with basic attributes as given emp name,emp_no,desig,basic_sal. Instantiate employee objects and calculate gross salary by providing appropriate earnings and deductions.
package week3;
class Employee1{
	String empName;
	int empNo;
